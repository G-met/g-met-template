...
export const createMetrologicalDataPattern = async (data: CreateMetrologicalDataPattern) =>
  httpBaseV2.post<void>("/metrological-data-patterns", data);

export const updateMetrologicalDataPattern = async (patternCode: string, data: UpdateMetrologicalDataPattern) =>
...
export const createComplementaryDataPattern = async (data: CreateComplementaryDataPattern) =>
  httpBaseV2.post<void>("/complementary-data-patterns", data);

export const updateComplementaryDataPattern = async (patternCode: string, data: UpdateComplementaryDataPattern) =>
